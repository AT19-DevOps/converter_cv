...
class TestImageBw(unittest.TestCase):
    ...
    def test_image_bw_valid_data(self):
        """Test the happy path"""
        image_bw = ImageBW(r'..\..\..\resources\Image.png', r'..\..\..\resources\Image.jpg').convert()
    ...
    def test_image_bw_invalid_extension_correct_mime_type_input(self):
        ...
        image_bw = ImageBW(r"..\..\..\resources\type_image_wrong_extension.txt", r"..\..\..\resources\type_image_wrong_extension.jpg").convert()
